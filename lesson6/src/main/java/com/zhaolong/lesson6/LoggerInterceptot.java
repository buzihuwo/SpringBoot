package com.zhaolong.lesson6;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.zhaolong.lesson6.entity.LoggerEntity;
import com.zhaolong.lesson6.jpa.LoggerJPA;
...
public class LoggerInterceptot implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        //获取请求sessionId
        String sessionld = request.getRequestedSessionId();
        //请求路径
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, @Nullable Exception ex) throws Exception {
        ...
        loggerEntity.setTime(new Timestamp(time));
        //设置请求时间差
    ...
    private <T> T getDAO(Class<T> myClass, HttpServletRequest request) {
        BeanFactory factory = WebApplicationContextUtils.getRequiredWebApplicationContext(request.getServletContext());
        return factory.getBean(myClass);
    }
}
